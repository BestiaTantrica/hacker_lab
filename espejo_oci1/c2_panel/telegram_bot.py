...
sys.path.append(os.path.join(C2_DIR, "..", "api"))
...
def get_persistent_keyboard():
    """Retorna la botonera fija (ReplyKeyboardMarkup) que queda anclada en la barra de entrada de Telegram."""
    return {
        "keyboard": [
            [{"text": "🌐 ABRIR C2 PANEL WEB"}]
        ],
...
def set_telegram_menu_button():
    """Configura el botón de Menú oficial de Telegram al lado de la barra de escribir."""
    if not TOKEN:
        return
