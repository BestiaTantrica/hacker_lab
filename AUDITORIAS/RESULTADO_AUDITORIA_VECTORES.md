...
| Vector 6 (AuthCode GET) | AuthCode GET (Con Sesión) | `https://cloud.mongodb.com/user/authCodeCreationTimestamp` | **200** | `N/A` | `{"authCodeCreationTimestamp":1783561024238,"errorCode":"NONE","version":"1","status":"OK"}` |
